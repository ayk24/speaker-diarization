...
from pyannote.audio.tasks import OverlappedSpeechDetection, SpeakerDiarization, VoiceActivityDetection
...
@pytest.fixture()
def protocol():
    return get_protocol("Debug.SpeakerDiarization.Debug", preprocessors={"audio": FileFinder()})
